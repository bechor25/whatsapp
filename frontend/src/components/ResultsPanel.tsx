  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h2 className="font-semibold text-slate-100 text-sm uppercase tracking-wide">
          ...
          <table className="w-full text-sm">
            <thead className="bg-slate-800/60 sticky top-0">
              <tr>
                ...
                <th className="px-4 py-2.5 text-left text-slate-400 font-medium">Phone</th>
                <th className="px-4 py-2.5 text-left text-slate-400 font-medium">Status</th>
                <th className="px-4 py-2.5 text-left text-slate-400 font-medium">Image</th>
              </tr>
            </thead>
            <tbody>
              {results.map((r) => {
                ...
                return (
                  <tr key={r.index} className="border-t border-slate-800/50 hover:bg-slate-800/20">
                    <td className="px-4 py-2.5 text-slate-400 text-xs">{r.index}</td>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex gap-1">
                            <a
                              ...
                              title="Open image"
                              aria-label={`Open generated image for ${r.name}`}
                            >
                            ...
                            <button
                              ...
                              aria-label={`Download generated image for ${r.name}`}
